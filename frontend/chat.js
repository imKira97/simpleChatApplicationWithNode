...
window.addEventListener("DOMContentLoaded", async () => {
  await axios
    .get("http://65.2.148.106:5000/", config)
    .then((res) => {
  ...
  await axios
    .get("http://65.2.148.106:5000/getGroup", config)
    .then((res) => {
...
async function groupMessageDiv(gId, gName) {
  ...
  await axios
    .get(`http://65.2.148.106:5000/isAdmin?groupId=${groupId}`, config)
    .then((res) => {
...
function addUserToGroup() {
  axios
    .get(`http://65.2.148.106:5000/usersNotInGroup?groupId=${groupId}`, config)
    .then((res) => {
...
function addNewUsersInGroup() {
  ...
  axios
    .post(`http://65.2.148.106:5000/addNewUser`, newUserData, config)
    .then((res) => {
      console.log(res);
    })
    .catch((err) => {
...
function exitFromGroup() {
  ...
  axios
    .post(
      "http://65.2.148.106:5000/exitUserFromGroup",
      { groupId: groupId },
      config
    )
    .then((res) => {
...
function displayAllUser() {
  axios
    .get(
      `http://65.2.148.106:5000/getAllUserFromGroup?groupId=${groupId}`,
      config
    )
    .then((res) => {
...
function makeAdmin(userId) {
  ...
  axios
    .put("http://65.2.148.106:5000/makeUserAdmin", data, config)
    .then((res) => {
      console.log(res);
...
function removeUser(userId) {
  ...
  axios
    .put("http://65.2.148.106:5000/removeUser", data, config)
    .then((res) => {
      console.log(res);
      $("#showAllUserModal").modal("hide");
    })
...
msgForm.addEventListener("submit", (e) => {
  ...
  axios
    .post("http://65.2.148.106:5000/sendMessage", data, config)
    .then((res) => {
      console.log(res);
    })
    .catch((err) => {
...
async function getMessage(groupId, groupName) {
  ...
  const res = await axios.get(
    `http://65.2.148.106:5000/getMessage?lastMessageId=${lastMessageId}&groupId=${groupId}`,
    config
  );
  console.log(res);
...
createGroupBtn.addEventListener("click", () => {
  axios
    .get("http://65.2.148.106:5000/getUserList", config)
    .then((res) => {
...
function createGroup() {
  ...
  if (groupName.length < 5) {
    ...
    axios
      .post("http://65.2.148.106:5000/createGroup", data, config)
      .then((res) => {
        console.log(res);
